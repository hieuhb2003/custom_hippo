...
from .information_extraction.openie_revised import RevisedOpenIE
...
class HippoRAG:
    def __init__(
        ...
        if self.global_config.openie_mode == "online":
            # Sử dụng RevisedOpenIE cho trường hợp online để thực hiện đơn giản hóa triplets
            self.openie = RevisedOpenIE(llm_model=self.llm_model)
                ...
                for chunk_id, row in new_openie_rows.items():
                    ...
                    if triplet_result:
                        ...
                        openie_info = {
                            ...
                            "extracted_triples": triplet_result.triples,
                        }
                        all_openie_info.append(openie_info)
