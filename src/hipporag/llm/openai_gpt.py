...
class CacheOpenAI(BaseLLM):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        try:
            run_dir = self.global_config.save_dir
            log_path = os.path.join(run_dir, "llm_calls.log")
            ...
            self.llm_log_path = log_path
        except Exception as e:
            logger.warning(f"Failed to initialize LLM file logging: {e}")
