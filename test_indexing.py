...
def main():
    parser = argparse.ArgumentParser(description="Build retrieved dataset using HippoRAG default retrieval (DPR/graph)")
    parser.add_argument("--input", default="/Users/khangtuan/Documents/memory/custom_hippo/longmemeval_0_500_v3.json")
    parser.add_argument("--output", default="outputs/retrieved_datasets/longmemeval_0_500_v3.default.json")
    parser.add_argument("--top_k", type=int, default=10)
    parser.add_argument("--llm", default="gpt-4o-mini")
    parser.add_argument("--embedding", default="text-embedding-3-small")
    parser.add_argument("--save_dir", default="outputs/default_build")
